 ...
 *  @property {WebSocketServer} ws WebSocket interface constructor
 ...
 */
Server.prototype.call = function(request, originalCallback, transport) {
  var self = this;
  ...
  maybeParse(request, this.options, function(err, request) {
    ...
    methodCallback.transport = transport;
    ...
    method.execute(self, request.params, methodCallback);
